                                        ...
                                        <div class="col-4">
                                            <div class="btn-group btn-group-toggle w-100" data-toggle="buttons">
                                                <div class="btn btn-secondary active col-6">
                                                    <input type="radio" name="type" value="0" id="option1" checked>
                                                    Реле
                                                </div>
                                                <div class="btn btn-secondary col-6">
                                                    <input type="radio" name="type" value="1" id="option2"> Диммер
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="col-4">
                                            <input class="form-control" type="number" name="maintain-value"
                                                   min="0.0" max="100.0" step="0.1" value="0">
                                        </div>
                                        <div class="col-4">
                                            <h1 class="h5">0</h1>
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="col-4">
                                            <input class="form-control" type="number" name="pid-kp"
                                                   min="-100" max="100" step="0.01" value="0">
                                        </div>
                                        <div class="col-4">
                                            <h1 class="h5">0.05</h1>
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="col-4">
                                            <input class="form-control" type="number" name="pid-dt"
                                                   min="0" max="4294967295" step="1" value="0">
                                        </div>
                                        <div class="col-4">
                                            <h1 class="h5">0.05</h1>
                                        </div>
