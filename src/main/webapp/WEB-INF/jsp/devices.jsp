            ...
            <a class="text-decoration-none" href="">
                <div class="card bg-dark-choco text-white">
                    <div class="card-body">
                        ...
                        <h5 class="font-weight-bold text-center bg-light-white text-dark-choco card-title py-2">Гідропоніка 1</h5>

                        <div class="text-muted d-sm-block d-xl-flex">
                            <span class="font-weight-bold p-0 m-0 mr-2 text-light-white">Модель:</span>
                            <span class="font-weight-bold p-0 m-0 mr-2 text-grey">CDH-1</span>
                        </div>
                        <div class="text-muted d-sm-block d-xl-flex">
