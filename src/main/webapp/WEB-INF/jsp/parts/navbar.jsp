    ...
    <div class="d-flex justify-content-between w-100">
        ...
        <div class="dropdown col-lg-1 align-self-center px-0 pl-2 pl-sm-2 pl-md-4 mx-0">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <div class="list-footer text-start px-3 text-dark">
                    <a href="#"><i class="fa fa-sign-in-alt py-2 pr-2"></i>Увійти</a>
                </div>
                <div class="list-footer text-start px-3 text-dark">
                    <a href="#"><i class="fa fa-user-alt py-2 pr-2"></i>Мій профіль</a>
                </div>
                <div class="list-footer text-start px-3 text-dark">
                    <a href="#"><i class="fa fa-sign-out-alt py-2 pr-2"></i>Вийти</a>
                </div>
            </div>
        </div>
